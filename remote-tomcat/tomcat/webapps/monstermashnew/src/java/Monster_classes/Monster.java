...
public class Monster {
    ...
    private double expAge() {
        return Math.exp(this.getAge().getTime() * Monster.AGE_RATE);
    }
    ...
    public double getSpeed() {
        return expValue(this.speed);
    }

    public double getAccuracy() {
        return expValue(this.accuracy);
    }

    public double getArmour() {
        return expValue(this.armour);
    }

    public double getDodge() {
        return expValue(this.dodge);
    }
